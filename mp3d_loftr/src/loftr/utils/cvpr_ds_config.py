...
_CN.REGRESS = CN()
_CN.REGRESS.D_MODEL = 256
_CN.REGRESS.D_FFN = 256
_CN.REGRESS.NHEAD = 8
_CN.REGRESS.LAYER_NAMES = ['self', 'cross']
_CN.REGRESS.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.REGRESS.TEMP_BUG_FIX = False
_CN.REGRESS.USE_POS_EMBEDDING = False
