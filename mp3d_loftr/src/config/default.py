...
_CN.LOFTR.REGRESS.D_MODEL = 256
_CN.LOFTR.REGRESS.D_FFN = 256
_CN.LOFTR.REGRESS.NHEAD = 8
_CN.LOFTR.REGRESS.LAYER_NAMES = ['self', 'cross']
_CN.LOFTR.REGRESS.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.REGRESS.TEMP_BUG_FIX = False
_CN.LOFTR.REGRESS.USE_POS_EMBEDDING = False
...
# RT 
_CN.LOFTR.LOSS.RT_WEIGHT_ROT = 0.0
_CN.LOFTR.LOSS.RT_WEIGHT_TR = 0.0

# Scale
_CN.LOFTR.LOSS.SCALE_WEIGHT = 0.0
...
# Use of different seed values might affect the final training result
_CN.TRAINER.SEED = 66

# new data options for mp3d
_CN.DATASET.TRAINVAL_DATA_SOURCE = "mp3d"
_CN.DATASET.TEST_DATA_SOURCE = "mp3d"
_CN.DATASET.TRAIN_DATA_JSON = '/home/cnris/data/mp3d_rpnet_v4_sep20/mp3d_planercnn_json/cached_set_train.json'
_CN.DATASET.VAL_DATA_JSON = '/home/cnris/data/mp3d_rpnet_v4_sep20/mp3d_planercnn_json/cached_set_val.json'
_CN.DATASET.TEST_DATA_JSON = '/home/cnris/data/mp3d_rpnet_v4_sep20/mp3d_planercnn_json/cached_set_test.json'
_CN.DEPTH_DIR = '/home/cnris/data/mp3d_rpnet_v4_sep20/observations'
_CN.DATA_DIR = '/home/cnris/data/mp3d_rpnet_v4_sep20'

# new data options for omnidata
_CN.DATASET.CAMERA_PATH = None
_CN.DATASET.IMG_PATH = None
